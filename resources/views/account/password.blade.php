			...
			<div class="card-body">
				...
				<form action="{{ route('account.password') }}" method="POST" class="custom-validation">
					...
					<div class="form-group row">
						...
						<div class="col-md-10">
							<input class="form-control" type="password" name="current_password" id="current_password" data-parsley-length="[6,255]" required>
						</div>
					</div>
					<div class="form-group row">
						<label for="new_password" class="col-md-2 col-form-label">New Password</label>
						<div class="col-md-10">
							<input class="form-control" type="password" name="new_password" id="new_password" data-parsley-length="[6,255]" required>
						</div>
					</div>
					<div class="form-group row">
						<label for="new_confirm_password" class="col-md-2 col-form-label">New Confirm Password</label>
						<div class="col-md-10">
							<input class="form-control" type="password" name="new_confirm_password" id="new_confirm_password" data-parsley-length="[6,255]" required>
						</div>
					</div>
