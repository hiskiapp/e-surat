    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                <form class="custom-validation" method="POST" action="{{ route('admin.users.store') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" type="text" name="sin" id="sin" value="{{ old('sin') }}" data-parsley-type="number" data-parsley-length="[16,255]" required>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" type="text" name="birth_place" id="birth_place" value="{{ old('birth_place') }}" data-parsley-length="[5,255]" required>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea id="address" name="address" class="form-control" maxlength="225" rows="3"></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" name="marital_status" id="marital_status" required>
                                <option selected disabled>Select *</option>
                                <option {{ old('marital_status') == 'Belum Kawin' ? 'selected' : '' }} value="Belum Kawin">Belum Kawin</option>
                                <option {{ old('marital_status') == 'Kawin' ? 'selected' : '' }} value="Kawin">Kawin</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" type="text" name="profession" id="profession" value="{{ old('profession') }}" data-parsley-length="[5,255]" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <p class='help-block'>Please leave empty if use date of birth as a password. Format: DD-MM-YYYY</p>
                        </div>
                    </div>
