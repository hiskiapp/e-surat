    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                <form class="custom-validation" method="POST" action="{{ route('admin.users.update', $user->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PATCH')
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <a class="image-popup-no-margins" href="{{ asset($user->photo) }}">
                                <img class="img-fluid" alt="{{ $user->name }}" src="{{ asset($user->photo) }}" width="120">
                            </a>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" type="text" name="sin" id="sin" value="{{ old('sin') ?? $user->sin }}" data-parsley-type="number" data-parsley-length="[16,255]" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="name" class="col-sm-2 col-form-label">Nama *</label>
                        <div class="col-sm-10">
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name') ?? $user->name }}" data-parsley-length="[5,255]" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="birth_place" class="col-sm-2 col-form-label">Tempat Lahir *</label>
                        <div class="col-sm-10">
                            <input class="form-control" type="text" name="birth_place" id="birth_place" value="{{ old('birth_place') ?? $user->birth_place }}" data-parsley-length="[5,255]" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="birth_date" class="col-sm-2 col-form-label">Tanggal Lahir *</label>
                        <div class="col-sm-10">
                            <input class="form-control" type="date" name="birth_date" id="birth_date" value="{{ old('birth_date') ?? $user->birth_date->format('Y-m-d') }}" required>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea id="address" name="address" class="form-control" maxlength="225" rows="3">{{ old('address') ?? $user->address }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" name="marital_status" id="marital_status" required>
                                <option selected disabled>Select *</option>
                                <option {{ $user->marital_status == 'Belum Kawin' ? 'selected' : '' }} value="Belum Kawin">Belum Kawin</option>
                                <option {{ $user->marital_status == 'Kawin' ? 'selected' : '' }} value="Kawin">Kawin</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" type="text" name="profession" id="profession" value="{{ old('profession') ?? $user->profession }}" data-parsley-length="[5,255]" required>
                        </div>
                    </div>
